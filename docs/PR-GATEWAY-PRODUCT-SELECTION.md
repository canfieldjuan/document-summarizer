...
- `npm run build` - passed after the saved-run locality and fallback-reachability fixes.
- `git diff --check` - passed.

## Estimated diff size

Actual after review reconciliation: thirteen files, 919 additions, and 87 deletions. This exceeds
